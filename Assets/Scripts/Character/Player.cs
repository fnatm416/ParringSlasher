...
public class Player : Character
{
    ...
    public Enemy opponent { get; set; } //현재 상대하고있는 적

    [SerializeField] private PanelEffect panelEffect; //피격 및 패링 이펙트를 출력시킬 패널
    [SerializeField] private float maxGuardTime; //최대 막기 유지시간
    [SerializeField] private float parryingTime;  //방패를 들고나서 패링이 가능한 시간
    [SerializeField] private float guardCoolTime; //막기 재사용 대기시간
    ...
    private void OnDisable()
    {
        ...
        if (!isDie) { anim.SetBool("IsMove", true); }
